...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-background">
      ...
      {/* AnchorPlayground Promotion Section */}
                  ...
                  <div className="flex-1 text-center md:text-left space-y-4">
                    <div>
                      <h3 className={`${syne} text-2xl sm:text-3xl font-bold mb-2`}>
                        Built by AnchorPlayground
                      </h3>
                      <p className="text-muted-foreground text-base sm:text-lg">
                      AnchorPlayground is a side project of <strong className="text-foreground">AnchorPlayground</strong>, 
                    ...
                    >
                      <a href="/" target="_blank" rel="noopener noreferrer">
                        Learn More About AnchorPlayground
