...
import { ArrowRight, CheckCircle2, Code2, AlertTriangle } from "lucide-react";
...
function HomePageContent() {
  const { isInitialized, program, programDetails, reset, isReinitializing, initialize } = useProgramStore();
  ...
  // auto-initialze with dummy wallet if we have programDetails
  useEffect(() => {
